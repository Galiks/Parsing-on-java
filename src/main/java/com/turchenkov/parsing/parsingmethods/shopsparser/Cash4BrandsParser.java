...
//                .requestBody("show_page")
        ...
        document = Jsoup.connect("https://cash4brands.ru/cashback/")
                .userAgent("Chrome/32.0.1667.0").data("key","Content-Type")
                .data("value","application/x-www-form-urlencoded")
                .data("description","").post();

        elements = document.select("section.shops").select("h3[itemprop]");
